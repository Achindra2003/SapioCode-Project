...
5. input and expected_output must be concrete values (not pseudocode).
   IMPORTANT: "input" must be a COMPLETE function call expression that can be
   eval'd directly, e.g. "two_sum([2,7,11,15], 9)" — NOT just the arguments
   like "[2,7,11,15], 9". The function name must match the problem's function.
